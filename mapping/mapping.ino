...
// --- NIEUW: DRAAI CORRECTIE VARIABELEN ---
// Stel hier in hoeveel graden de robot MAX mag draaien voordat de correctie triggert.
// 2.153 ticks per graad (775 ticks / 360°)
// Aanbevolen: tussen 120° en 170° (echte 90° bocht detecteert via lijnsensor voor deze drempel)
...
void startDraai(int spdL, int spdR) {
  ...
  // Sla de richtingen op voor een eventuele omkeeractie (U-turn correctie)
  laatsteSpdL = spdL;
  laatsteSpdR = spdR;
  setMotorLinks(spdL);
  setMotorRechts(spdR);
